...
export function Projects(){
    ...
    return(
        <div className="max-w-7xl m-auto flex flex-wrap justify-center gap-16 text-zinc-600 max-md:flex-col has-shown">
            {
                repos.length === 0? (<p className="lds-ripple"><div></div></p>) : (
                    repos.map((repo)=>(
                        <div key={repo.id} className="card flex flex-col justify-between w-1/3 p-8 rounded-md shadow-lg max-md:w-full">
